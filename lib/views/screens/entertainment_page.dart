...
import 'package:news_app_/services/entertainment_api.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Container(
          ...
          child: Text("Entertainment",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18,color: Colors.white),)),
          ...
          children: [
            Expanded(
              child: FutureBuilder<List<Article>>(
                future: EntertainmentApiService().fetchEntertainmentNews(),
